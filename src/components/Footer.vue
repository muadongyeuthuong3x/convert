...
<footer>
    <div class="rowfoot1">
        ...
        <ul class="colfoot">
            ...
            <li><a href="/he-thong-sieu-thi-the-gioi-di-dong" title="Tìm siêu thị (2.229 shop)">Tìm siêu thị <span>(2.229 shop)</span></a></li>
                <li>
                    <a class="viewmb" rel="nofollow" href="/?PostmanRuntime=1&amp;viewtype=desktop&amp;chooseprovince=1&sclient=mobile" title="Xem bản mobile">Xem bản mobile</a>
                </li>
        </ul>
        <ul class="colfoot">
            <li>
        ...
        <ul class="colfoot collast">
            <li>
                ...
                <a target="_blank" href="https://www.youtube.com/user/TGDDVideoReviews?sub_confirmation=1" class="linkyt" rel="noopener">
                    <i class="icontgdd-share3"></i>762k
                </a>
                <div class="group">
